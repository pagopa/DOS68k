...
Pull Requests are welcome for documentation and community-related changes.

Each Pull Request should:
- Clearly describe what is being changed
- Explain the motivation behind the change
- Be appropriate for an early-stage project
...
This document will be refined and expanded as the project evolves.
