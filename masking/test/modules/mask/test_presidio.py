...
class TestPresidioModelConfig:
    def test_valid(self) -> None:
        ...
        cfg: PresidioModelConfig = PresidioModelConfig(
    ...
    def test_extra_field_rejected(self) -> None:
        ...
        with pytest.raises(ValidationError):
            PresidioModelConfig(
                lang_code="en", model_name="en_core_web_md", extra="bad"
            )
    ...
    def test_validate_missing_entity_mapping(self) -> None:
        ...
        with pytest.raises(ValueError, match="entity_mapping"):
            self.anonymizer.validate(
                {"entity_type": "PERSON", "deanonymize_mapping": {}}
            )
...
class TestPresidioPII:
    def test_mask_pii_no_pii(
        self, monkeypatch: pytest.MonkeyPatch, presidio_instance: PresidioPII
    ) -> None:
    ...
    def test_detect_language_no_matching_languages(
        self, monkeypatch: pytest.MonkeyPatch, presidio_instance: PresidioPII
    ) -> None:
    ...
    def test_detect_pii_non_italian(
        self, monkeypatch: pytest.MonkeyPatch, presidio_instance: PresidioPII
    ) -> None:
