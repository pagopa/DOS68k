...
@pytest.mark.asyncio
async def test_redis_vector_db_semantic_search_empty_filters(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
...
@pytest.mark.asyncio
async def test_redis_vector_db_semantic_search_with_filters(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
...
@pytest.mark.asyncio
async def test_redis_vector_db_filter_search_ne_operator(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
...
@pytest.mark.asyncio
async def test_redis_vector_db_filter_search_nin_operator(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
    ...
    async with RedisVectorDB() as db:
        results = await db.filter_search(
            index_name="test_index",
            filters=MetadataFilters(filters=[MetadataFilter(key="filename", value="file1.txt", operator=FilterOperator.NIN)]),
            max_results=5,
        )
...
@pytest.mark.asyncio
async def test_redis_vector_db_filter_search_text_match(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
...
@pytest.mark.asyncio
async def test_redis_vector_db_filter_search_text_match_insensitive(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
...
@pytest.mark.asyncio
async def test_redis_vector_db_filter_search_range_operators(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
...
@pytest.mark.asyncio
async def test_redis_vector_db_filter_search_or_condition(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
...
@pytest.mark.asyncio
async def test_redis_vector_db_filter_search_nested_filters(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
    monkeypatch.setattr(implementation, "AsyncSearchIndex", AsyncSearchIndexMock)
...
@pytest.mark.asyncio
async def test_redis_vector_db_aquery_no_embedding_no_filters(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(implementation, "get_redis_connection_pool", get_queue_pool_mock)
    monkeypatch.setattr(implementation, "RedisAsync", RedisClientMock)
