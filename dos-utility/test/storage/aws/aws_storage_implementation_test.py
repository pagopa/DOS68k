...
from dos_utility.storage.aws.env import get_aws_storage_settings
from dos_utility.utils.aws import get_aws_credentials_settings

from test.storage.aws.mocks import (
    get_aws_storage_settings_mock,
    aws_client_mock,
    aws_client_list_buckets_exception_mock,
    get_aws_storage_settings_with_endpoint_mock,
)
...
def test_instantiate_aws_s3(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr(
        implementation, "get_aws_storage_settings", get_aws_storage_settings_mock
    )
    monkeypatch.setattr(
        implementation,
...
def test_aws_s3_is_healthy_failure(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr(
        implementation.boto3, "client", aws_client_list_buckets_exception_mock
    )
