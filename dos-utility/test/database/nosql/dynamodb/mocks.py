...
class _MockBoto3Table:
    ...
    def update_item(self: Self, Key: Dict[str, Any], UpdateExpression: str, ExpressionAttributeNames: Dict[str, str], ExpressionAttributeValues: Dict[str, Any], ReturnValues: Optional[str] = None) -> Dict[str, Any]:
        return {"Attributes": {"id": "123", "name": "Updated Test Item"}}

    def query(self: Self, KeyConditionExpression: Any, ScanIndexForward: bool = True, Limit: Optional[int] = None, IndexName: Optional[str] = None, Select: Optional[str] = None) -> Dict[str, Any]:
        return {"Items": [{"id": "123", "name": "Test Item"}], "Count": 1}

    def scan(self: Self, Limit: Optional[int] = None, ExclusiveStartKey: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
def boto3_dynamodb_resource_not_healthy_mock(*args, **kwargs) -> MockBoto3DynamoDBResourceNotHealthy:
