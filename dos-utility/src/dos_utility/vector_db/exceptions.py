...
class IndexCreationException(Exception):
    ...
    def __init__(self: Self, msg: str):
        super().__init__(
            f"Index creation failed in the vector database. Details: {msg}"
        )
...
class IndexDeletionException(Exception):
    ...
    def __init__(self: Self, msg: str):
        super().__init__(
            f"Index deletion failed in the vector database. Details: {msg}"
        )
...
class PutObjectsException(Exception):
    ...
    def __init__(self: Self, msg: str):
        super().__init__(
            f"Putting objects failed in the vector database. Details: {msg}"
        )
...
class DeleteObjectsException(Exception):
    ...
    def __init__(self: Self, msg: str):
        super().__init__(
            f"Deleting objects failed in the vector database. Details: {msg}"
        )
